...
$endif
$onlyIf[$voiceID==$voiceID[$clientID];you're not in the same vc as me{extraOptions: {delete:5s}}]
$if[$hasPlayer==false]
$joinVc
$endif
$onlyIf[$voiceID[$authorID]!=;join a vc {extraOptions:{delete:5s}}]
$deletecommand
$onlyForChannels[$getGuildVar[channelid];]
`})